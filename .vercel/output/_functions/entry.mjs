...
import { manifest } from './manifest_DpJlyTAX.mjs';

const serverIslandMap = new Map();;

const _page0 = () => import('./pages/_image.astro.mjs');
const _page1 = () => import('./pages/products/_---id_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/products/[...id].astro", _page1],
...
const _args = {
    "middlewareSecret": "ea4fdf1c-d562-4be1-a858-48077b841ae3",
